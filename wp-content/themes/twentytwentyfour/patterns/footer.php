	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:50%">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"level":2,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontFamily":"body"} -->
					<!-- <h2 class="wp-block-heading has-medium-font-size has-body-font-family" style="font-style:normal;font-weight:600"><?php //esc_html_e( 'Social', 'twentytwentyfour' ); 
																																			?></h2> -->
					<!-- /wp:heading -->
					...
					<!-- wp:navigation-link {"label":"<?php //esc_html_e('Facebook', 'twentytwentyfour'); 
														?>","url":"#"} /-->
					<!-- wp:navigation-link {"label":"<?php //esc_html_e('Instagram', 'twentytwentyfour'); 
														?>","url":"#"} /-->
					<!-- wp:navigation-link {"label":"<?php //esc_html_e('Twitter/X', 'twentytwentyfour'); 
														?>","url":"#"} /-->
